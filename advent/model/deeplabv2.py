...
class ResNetMultiCrCDA(ResNetMulti):
    ...
    def __init__(self, block, layers, num_classes, num_mini_patch_clusters, num_patch_clusters):
        super().__init__(block, layers, num_classes, False)
        # Classification Module for Mini-patch-scale Label
        self.layer6_c2 = ClassifierModule(2048, [6, 12, 18, 24], [6, 12, 18, 24], num_mini_patch_clusters)
        # Classification Module for Patch-scale Label
        self.layer6_c3 = ClassifierModule(2048, [6, 12, 18, 24], [6, 12, 18, 24], num_patch_clusters)
    ...
    def get_10x_lr_params(self):
        ...
        if self.multi_level:
            b.append(self.layer5.parameters())
        b.append(self.layer6.parameters())
        b.append(self.layer6_c2.parameters())
        b.append(self.layer6_c3.parameters())
...
def get_deeplab_v2_crcda(num_classes=19, num_mini_patch_clusters=20, num_patch_clusters=20):
    model = ResNetMultiCrCDA(Bottleneck, [3, 4, 23, 3], num_classes, num_mini_patch_clusters, num_patch_clusters)
    return model
